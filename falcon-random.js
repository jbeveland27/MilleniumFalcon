...
function playVideo(selection) {
    ...
    /** 
    // Determine if hyperfail should occur
    // Conditions:
    //     After 3 successful launches, hyperfail can occur
    //     When hyperfail can occur, it should randomly happen 1 / 3 tries 
    ...
    */
    ...
    if (selection === "h") {
        if (hyperfail) {
            ...
            omxp1.open('./media/MF Hyperfail.mp4', opts1);
